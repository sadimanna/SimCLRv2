...
parser.add_argument("--train-dir", type=Path, default="./datasets/ImageNet100/train")
parser.add_argument("--val-dir", type=Path, default="./datasets/ImageNet100/val")
parser.add_argument("--log-dir", type=Path, default="./benchmark_logs_im100")
...
METHODS = {
    "simclrv2": {"model": simclrv2.SimCLR_v2, "transform": simclrv2.transform},
}
...
def pretrain(
    ...
    trainer = Trainer(
        ...
        precision=precision,
        strategy="auto", #ddp", #_find_unused_parameters_true",
        sync_batchnorm=True,
